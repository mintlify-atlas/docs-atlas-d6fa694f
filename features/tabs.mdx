...
<CardGroup cols={2}>
  ...
  <Card title="Browser Automation" href="/guides/common-patterns" icon="robot">
    Automate browser interactions
  </Card>
  <Card title="Tabs API" href="/api/tabs" icon="code">
    Complete tab API reference
  </Card>
  <Card title="Snapshot API" href="/api/snapshot" icon="camera">
