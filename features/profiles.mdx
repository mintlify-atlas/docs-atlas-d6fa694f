...
<CardGroup cols={2}>
  ...
  <Card title="Session Management" href="/guides/session-management" icon="key">
    Manage login sessions and cookies
  </Card>
  <Card title="Profile API" href="/api-reference/profiles" icon="code">
    Complete API reference
  </Card>
  <Card title="Multi-User Workflows" href="/guides/multi-user" icon="users">
