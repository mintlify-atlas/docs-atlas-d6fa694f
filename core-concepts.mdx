...
<CardGroup cols={2}>
  <Card title="Instance API" icon="window" href="/api/instances">
    Complete instance endpoints and operations
  </Card>
  
  <Card title="Tabs API" icon="browser" href="/api/tabs">
    Tab management and interaction endpoints
  </Card>
  
  <Card title="Profile API" icon="folder" href="/api/profiles">
