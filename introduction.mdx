...
<img className="block dark:hidden" src="/logo/light.svg" alt="PinchTab" />
<img className="hidden dark:block" src="/logo/dark.svg" alt="PinchTab" />
...
<CardGroup cols={2}>
  <Card title="AI Agent Automation" icon="wand-magic-sparkles" href="/guides/ai-agent-integration">
    Build AI agents that can browse, click, fill forms, and extract data from any website.
  </Card>
  
  <Card title="Web Scraping" icon="spider-web" href="/guides/common-patterns">
    Extract text efficiently (~800 tokens/page) instead of expensive screenshots (10,000+ tokens).
  </Card>
  
  <Card title="End-to-End Testing" icon="vial" href="/guides/common-patterns">
    Automate browser testing with stable element references and multi-instance parallelization.
  </Card>
  
  <Card title="Multi-Account Management" icon="users" href="/guides/multi-instance">
...
<CardGroup cols={2}>
  ...
  <Card title="Examples" icon="lightbulb" href="/guides/common-patterns">
